# Taller de introducción al procesamiento básico de textos en R por @espejolento
# Una versión anterior de este taller se realizó en el meetup de RLadiesCDMX en BiblioColmex (https://github.com/silviaegt/RLadiesCDMX_talleres)
...
archivoAMLO <- "textos-mexico/20181201_amlo.txt"
